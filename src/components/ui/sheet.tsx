...
// Drawers laterais (left/right) ocupam altura total da viewport — em iOS com notch
// precisam respeitar a safe-area-inset-top, senão o conteúdo encosta na Dynamic Island.
// Drawers de topo (top) também precisam. Drawer de baixo só do home indicator.
  ...
  "fixed z-50 gap-4 bg-background p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
        ...
        left:
          "inset-y-0 left-0 h-full w-3/4 border-r data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left sm:max-w-sm pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)]",
        right:
